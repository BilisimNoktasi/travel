				...
				<SwiperSlide>
					<div className="card-news background-card hover-up">
						...
						<div className="card-info">
							<div className="card-meta"> <span className="post-date neutral-1000">12 {t("dcmbr")} 2024</span><span className="post-time neutral-1000">6 {t("mins")}</span><span className="post-comment neutral-1000">38 {t("comments")}</span></div>
