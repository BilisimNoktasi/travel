	...
	return (
		<>
			<div className="card-journey-small background-card">
				<div className="card-image"> <Link className="label" href="#">{t("topRates")}</Link><Link className="wish" href="#">
					...
					<div className="card-program">
						...
						<div className="endtime">
							<div className="card-price">
								...
								<p className="text-md-medium neutral-300">{t("night")}</p>
							</div>
							<div className="card-button"> <Link className="btn btn-gray" href="#">{t("bookNow")}</Link></div>
						</div>
					</div>
				</div>
			</div>
