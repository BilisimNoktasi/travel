      ...
      <section className="box-section box-breadcrumb background-body">
        <div className="container">
          <ul className="breadcrumbs">
            ...
            <li> <span className="text-breadcrumb">{villa?.title.toLowerCase()}</span></li>
          </ul>
        </div>
      </section>
          ...
          <div className="tour-header">
            ...
            <div className="tour-metas">
              <div className="tour-meta-left">
                ...
                </p><Link className="text-md-medium neutral-1000" href="#">{villa?.type}</Link>
              </div>
                ...
                <div className="group-collapse-expand">
                  ...
                  <div className={isAccordion == 1 ? "collapse" : "collapse show"} id="collapseOverview">
                    <div className="card card-body">
                      <div dangerouslySetInnerHTML={{ __html: villa?.icerik || ''}}></div>
                    </div>
                  </div>
                </div>
                <div className="group-collapse-expand">
