...
import { getTourDispatch } from "@/redux/tourSlice";
import { swiperGroup1, swiperGroup2, swiperGroupTestimonials1 } from "@/util/swiperOption";
                        ...
                        <Swiper {...swiperGroupTestimonials1}>
                          {tour?.images.map((item, index) => (
                            <SwiperSlide key={index}>
                              <img
                                src={`${process.env.NEXT_PUBLIC_SOURCE_URI}${item}`}
                                alt="Travile"
                              />
                            </SwiperSlide>
                          ))}
                  ...
                  <div className="box-info-tour">
                    <div className="tour-info-group">
                      ...
                      <div className="info-item">
                        ...
                        <p className="text-lg-bold neutral-1000">{tour?.duration} hours</p>
                      </div>
                    </div>
                    <div className="tour-info-group">
                      ...
                      <div className="info-item">
                        ...
                        <p className="text-lg-bold neutral-1000">{tour?.groupSize} people</p>
                      </div>
                    </div>
                    <div className="tour-info-group">
                      ...
                      <div className="info-item">
                        ...
                        <p className="text-lg-bold neutral-1000">{tour?.tourCategory}</p>
                      </div>
                    </div>
                    <div className="tour-info-group">
                      ...
                      <div className="info-item">
                        ...
                        <div style={{display:'flex',flexDirection:'row',columnGap:8}}>
                        {
                          tour?.languages.map((item,index)=> (
                            <p className="text-xs-bold neutral-1000">{item}</p>
                          ))
                        }
                        </div>
                      </div>
